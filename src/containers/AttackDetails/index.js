  ...
  const toggleContent = () => {
    ...
    if (!accordionExpanded && url !== 'null') {
      return (
        <Image
          resizeMode={'contain'}
          style={{ flex: 1, height: 300, width: 400 }}
          defaultSource={logo}
        />
      )
    }
    ...
    return (
      ...
      >
        <Accordion
          ...
          content={<GifContainer url={selectedMove.preview_url} accordionExpanded={this.state.accordionExpanded} isLoadingImage={isLoadingImage} updateImageState={this.updateImageState} />}
          easing="easeOutCubic"
        />
